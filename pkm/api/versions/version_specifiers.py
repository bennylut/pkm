...
class VersionSpecifier(ABC):
    ...
    def is_none(self):
        return self.min == self.max and self.includes_min == self.includes_max == False

    def is_any(self):
        return (self.min is self.max is None) and self.includes_min == self.includes_max == True
