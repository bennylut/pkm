...
def build_app_installer(application_project: Project, target_dir: Optional[Path]) -> Path:
    ...
    with temp_dir() as tdir:
        ...
        installer_source_dir = tdir / 'src' / PackageDescriptor.normalize_name(installer_project_name).replace('-', '_')
...
def build_app_installation(installer_project: Project, repository: Repository, output_dir: Path) -> Path:
    """
...
class ApplicationInstallerProjectWrapper(Package):
    ...
    def install_to(self, env: "Environment", user_request: Optional["Dependency"] = None, *,
        ...
        with temp_dir() as tdir:
            ...
            SourceDistribution(self.descriptor, installer, build_packages_repo) \
