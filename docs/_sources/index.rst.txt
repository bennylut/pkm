...
The above command is safe to be used in your global python environment, :doc:`read more about pkm installation<installation>`.

What Can I Use it For?
----------------------
- Install python applications and libraries (like :program:`pip` and :program:`pipx`)
- Manage your virtual environments
  - Build them (like :program:`venv`)
  - Enable package sharing between multiple environments
- Manage your python projects:
    - Generate projects via templates (like :program:`cookiecutter` and :program:`copier`)
    - Build, package and deploy projects (like :program:`pipenv`, :program:`poetry` and :program:`twine`)
    - Distribute self-contained applications
    - Build and maintain multi-package projects
    - Create tasks to automate your project management (like :program:`poethepoet`)
    - And way more!
